...
int main(int argc, char** argv) {
    ...
    printf("Broadcast Address:----------> %d.%d.%d.%d\n", wildcard_netmask_block[B1] & netmask_block[B1], wildcard_netmask_block[B2] & address_block[B2], wildcard_netmask_block[B3] & address_block[B3], wildcard_netmask_block[B4] & netmask_block[B4]);
    
    printf("Lowest Usable Address:------> %d.%d.%d.%d\n", address_block[B1] & netmask_block[B1], address_block[B2] & netmask_block[B2], address_block[B3] & netmask_block[B3], (address_block[B4] & netmask_block[B4]) + 1);
    printf("Highest Usable Address:-----> %d.%d.%d.%d\n", address_block[B1] & netmask_block[B1], address_block[B2] & netmask_block[B2], address_block[B3] & netmask_block[B3], (address_block[B4] & netmask_block[B4]) + 1);
}
